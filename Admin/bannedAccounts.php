                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Banned Accounts</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" cellspacing="0" width="100%">
                                            ...
                                            <?php
												...
												$fetch = "SELECT c.*, b.* FROM ban b JOIN customer c ON c.C_ID = b.C_ID";
												...
												?>
													<tr>
														...
														<td><?php echo $data['B_from'];?></td>
														<td><?php echo $data['B_to'];?></td>
														<td><?php echo $data['B_reason'];?></td>
														<td>
