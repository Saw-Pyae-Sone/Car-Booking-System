...
<head>
    ...
    <!-- Title Page-->
    <title>Warning Inactive Accounts</title>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Warning Inactive Accounts</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body card_block">
								...
								<h5 id="addrow" class="pb-2"> Warning Inactive Accounts</h5>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" cellspacing="0" width="100%">
											...
											<?php
												...
												$fetch = "SELECT * FROM customer WHERE C_login_time < DATE_SUB(NOW(), INTERVAL 5 MONTH) AND C_status != 'Inactive' AND C_status != 'Ban';";
...
<?php
    ...
    if(isset($_POST["warning"]))
    {
        ...
        $mail -> Subject = 'A Message from ThreeB';
        $mail -> Body = 'We hope this email finds you well. We wanted to bring to your attention that we have noticed inactivity on your account for the past 5 months.

		To ensure the security and protection of your account, we kindly ask that you log in and review your account activity. If you have forgotten your login credentials, please use the "Forgot Password" link on our website to reset your password.
		...
		if (!$mail->send()) {
            ...
            $update = "UPDATE customer set C_status = 'Inactive' WHERE C_ID = '$CID'";
            $add = mysqli_query($connect, $update);
            if($update)
				echo "<script> alert('An email has been sent'); document.location.href = 'warninginactiveAccounts.php';</script>";
            else
