                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Cancelled Bookings</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body card_block">
								...
								<h5 id="addrow" class="pb-2"> Cancelled Bookings</h5>
								...
								<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" cellspacing="0" width="100%">
											...
											<?php
												...
												$fetch = "SELECT * FROM booking WHERE BK_cancel = 'Cancelled'";
													...
													<tr>
														...
														<td>
															...
															<div class="form-button-action">
																<button type="submit" class="btn btn-danger btn-md" name="undo" value="<?php echo $data['BK_ID'];?>">Undo</button>
															</div>
                                                            </form>
														</td>
													</tr>
...
if(isset($_POST['undo']))
{
	...
	$update = "UPDATE booking set BK_cancel = 'Uncancelled' WHERE BK_ID = '$undoid'";
	$run = mysqli_query($connect,$update);
	if($update)
		echo "<script>alert('Undo Cancel'); location.href('cancelledBookings.php');</script>";
}
?>
</html>
<!-- end document-->
