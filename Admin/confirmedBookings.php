                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body card_block">
								...
								<h5 id="addrow" class="pb-2"> Confirmed Bookings</h5>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" cellspacing="0" width="100%">
											...
											<tbody>
												...
												$fetch = "SELECT * FROM booking WHERE BK_confirm = 'Confirmed'";
													...
													<tr>
														...
														<td>
															...
															<div class="form-button-action">
																<?php
                                                                    if($data['BK_pay'] == 'Unpaid')
                                                                    {
                                                                ?>
                                                                	<button type="submit" class="btn btn-success btn-md" name="pay" value="<?php echo $data['BK_ID'];?>">Pay</button>
                                                                <?php
                                                                    }
                                                                    else
                                                                    {
                                                                ?>
																<button type="submit" value="<?php echo $data['BK_ID'];?>" name="undo" data-toggle="tooltip" class="btn btn-link btn-simple-danger" data-original-title="Undo">
...
<?php
	...
	if(isset($_POST['pay']))
	{
		...
		$update = "UPDATE booking set BK_pay = 'Paid' WHERE BK_ID = '$bkid'";
		$run = mysqli_query($connect,$update);
		echo "<script>alert('Payment has been confirmed'); location.href ='confirmedBookings.php';</script>";
	}
	...
	if(isset($_POST['undo']))
	{
		...
		$update2 = "UPDATE booking set BK_pay = 'Unpaid' WHERE BK_ID = '$undoid'";
		$run2 = mysqli_query($connect,$update2);
		echo "<script>alert('Undo Payment'); location.href='confirmedBookings.php';</script>";
	}
