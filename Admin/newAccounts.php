                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">New Accounts</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body card_block">
								...
								<h5 id="addrow" class="pb-2 mb-2">New Accounts</h5>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" cellspacing="0" width="100%">
											...
											<?php
												...
												$query = "SELECT * FROM customer WHERE C_status = 'Active' Order by C_ID DESC LIMIT 7";
