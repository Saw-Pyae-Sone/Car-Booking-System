                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Daily Records</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body card_block"></div>
                                <?php
                                    if(isset($_POST['btn']))
                                    {
                                        $date = $_POST['day'];
                                ...
                                <div style="margin-left: 55em; margin-bottom: 1em;" class="d-flex flex-row">
                                    <form action="" method="post">
                                        <input type="date" name="day" class="btn btn-white" required value = "<?php echo $date ?>">
                                        <input type="submit" value="Change" name="btn" class="btn btn-success">
                                    </form>
                                </div>
								
								<h5 id="addrow" class="pb-2 mb-3 ml-3">Daily Servicing Records of  Day <?php echo date("d", strtotime($date))?></h5>
                                        ...
                                        <table id="add-row" class="display table table-striped table-hover" cellspacing="0" width="100%">
                                            <thead>
                                                ...
                                                <?php
                                                    ...
                                                    $fetch = "SELECT * FROM booking b JOIN services s ON b.S_ID = s.S_ID WHERE b.BK_date = '$date'";
                                ...
                                <div style="margin-left: 55em; margin-bottom: 1em;" class="d-flex flex-row">
                                    <form action="" method="post">
                                        <input type="date" name="day" class="btn btn-white" required value = "<?php echo $cdate ?>">
                                        <input type="submit" value="Change" name="btn" class="btn btn-success">
                                    </form>
                                </div>

								<h5 id="addrow" class="pb-2 mb-3  ml-3">Daily Servicing Records of  Day <?php echo $cdate?></h5>
								<div class="bd-example">
                                        ...
                                        <table id="add-row" class="display table table-striped table-hover" cellspacing="0" width="100%">
                                            <thead>
                                                ...
                                                <?php
                                                    ...
                                                    $fetch = "SELECT * FROM booking b, services s WHERE b.S_ID = s.S_ID AND DAY(b.BK_date) = '$cdate' AND YEAR(b.BK_date) = '$cyear' AND MONTH(b.BK_date) = '$cmonth'";
                                                    $run = mysqli_query($connect,$fetch);
                                                    $count = mysqli_num_rows($run);
